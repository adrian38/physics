...
const routes: Routes = [
    ...
    },
    {
        ...
        loadChildren: () => import('./pages/simulation-view/simulation-view.module').then((m) => m.SimulationViewPageModule),
        canActivate: [AuthGuardService],
    },
    {
        path: 'simulation-detail/:id',
        loadChildren: () => import('./pages/simulation-detail/simulation-detail.module').then((m) => m.SimulationDetailPageModule),
        canActivate: [AuthGuardService],
    },
    {
        path: 'login',
    ...
    {
        path: 'electrostática',
        loadChildren: () => import('./pages/electrostatica/electrostatica.module').then((m) => m.ElectrostaticaPageModule),
        canActivate: [AuthGuardService],
    },
    {
        path: 'corriente',
        loadChildren: () => import('./pages/corriente/corriente.module').then((m) => m.CorrientePageModule),
        canActivate: [AuthGuardService],
    },
    {
        path: 'magnetismo',
        loadChildren: () => import('./pages/magnetismo/magnetismo.module').then((m) => m.MagnetismoPageModule),
    },
    {
        path: 'quiz',
...
export class AppRoutingModule {
    constructor(private _utilsService: UtilsService, public navController: NavController) {
